<template>
  <div v-if="inSetup" class="template-container">
    ...
    <div ref="template6" class="template template-6"><span>6</span></div>
    <div ref="template7" class="template template-7"><span>7</span></div>
    <div ref="template8" class="template template-8"><span>8</span></div>
  </div>
  <div v-else class="template-container active">
    ...
    <div ref="template5" class="template template-6 active">
      <TemplateCard
        key="templateCard5"
        template="templateCard5"
        :tnum="5"
        :layout="layout[5]"
        :widget="props.widgets['templateCard5']"
        :pageIndex="props.pageIndex"
      />
    </div>

    <div ref="template6" class="template template-7 active">
      <TemplateCard
        key="templateCard6"
        template="templateCard6"
        :tnum="6"
        :layout="layout[6]"
        :widget="props.widgets['templateCard6']"
        :pageIndex="props.pageIndex"
      />
    </div>
    <div ref="template7" class="template template-8 active">
      <TemplateCard
        key="templateCard7"
        template="templateCard7"
        :tnum="7"
        :layout="layout[7]"
        :widget="props.widgets['templateCard7']"
        :pageIndex="props.pageIndex"
      />
    </div>
  </div>
...
const template6 = useTemplateRef("template6");
const template7 = useTemplateRef("template7");
const template8 = useTemplateRef("template8");
const templateAr = [
  template1,
  template2,
  template3,
